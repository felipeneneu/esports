    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="grid grid-cols-6 gap-6 mt-16"> 
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 right-0 left-0">
          <strong className='font-bold text-white block'>Counter Strike 2</strong>
          <span className='text-zinc-300 text-sm block mt-1'>4 anuncios</span>
        </div>
        </a>
        <a href="" className="relative rounded-lg overflow-hidden">
      ...
      <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center">
        ...
        <button className="py-4 px-3 bg-violet-500 hover:bg-violet-800 text-white rounded flex items-center gap-3">
